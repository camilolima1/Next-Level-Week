...
function populateUFs(){
    ...
    fetch("http://servicodados.ibge.gov.br/api/v1/localidades/estados?orderBy=name")
        .then( res => res.json() )
        .then( states => {
...
function handleSelectedItem(event){
    ...
    //se já tiver selecionado, tem que tirar da seleção
    if( alreadySelected >= 0 ){
        ...
        //se não tiver tem que adicionar a seleção
        selectedItems.push(itemId)
    }
    // console.log('selectedItems', selectedItems)

    //atualizar o campo, input, escondido
